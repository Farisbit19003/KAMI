      ...
      <div className="flex justify-center items-center inset-0 fixed backdrop-blur-sm bg-opacity-5">
        <div className="bg-red-500 p-4 rounded-md md:w-[30rem]  shadow-lg">
          ...
          <div className="flex gap-2 mb-2 flex-col">
            ...
            <input
              type="number"
              className="h-10 w-full p-3 rounded-md outline-none focus:ring-2 focus:ring-red-600"
          ...
          <div className="flex gap-2 mb-2 flex-col">
            ...
            <textarea
              className="h-10 w-full p-2 flex  rounded-md outline-none focus:ring-2 focus:ring-red-600"
